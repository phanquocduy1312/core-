...
> Bản kế hoạch này được thay thế ngày 09/09/2026 theo phản hồi người dùng: PDF được rút gọn từ 40 còn 24 trang, bỏ nội dung tạo trang mới/SEO/HTML-CSS và chuyển trọng tâm sang ảnh chụp Builder giữ nguyên giao diện. Nhãn đặt ở dải bên phải, nối bằng nét mảnh tới đúng vị trí.
