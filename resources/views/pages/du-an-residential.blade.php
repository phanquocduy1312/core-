...
<style>
    ...
    .elementor-10034 .hero-projects-section {
    ...
    .elementor-10034 .project-filter-section {
        background-color: #FFFFFF !important;
        padding: 50px 0 80px 0 !important;
        width: 100% !important;
    }
    .elementor-10034 .project-filter-section .elementor-container {
    ...
    .elementor-10034 .project-filter-section .elementor-widget-wrap {
        width: 100% !important;
        display: block !important;
    }

    /* Filter Tabs List */
    .elementor-10034 .filter-tabs-wrapper {
        width: 100% !important;
        margin-bottom: 45px !important;
        text-align: center !important;
    }
    .elementor-10034 .elementor-icon-list-items {
        display: flex !important;
        justify-content: center !important;
        align-items: center !important;
    ...
    .elementor-10034 .elementor-icon-list-item {
        margin: 0 !important;
        padding: 0 !important;
        display: inline-block !important;
    }
    .elementor-10034 .elementor-icon-list-item a {
        font-family: "DIN", sans-serif !important;
    ...
    .elementor-10034 .elementor-icon-list-item a:hover {
        color: #EAA931 !important;
    }
    .elementor-10034 .elementor-icon-list-item.active a,
    .elementor-10034 .elementor-icon-list-item a.active {
        color: #EAA931 !important;
    ...
    .elementor-10034 .premium-blog-entry-title a:hover {
        color: #EAA931 !important;
    }
    .elementor-10034 .premium-blog-entry-location {
        font-family: "DIN", sans-serif !important;
